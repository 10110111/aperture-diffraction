    ...
    : QDockWidget(tr("Tools"),parent)
{
    ...
    globalRotationAngle_ = addManipulator(layout, this, tr(u8"&Rotation angle"), -90, 90, 0, 4, u8"°");
    ...
    curvatureRadius_ = addManipulator(layout, this, tr(u8"Radius of &curvature of side"), 1, 50, 50, 2);

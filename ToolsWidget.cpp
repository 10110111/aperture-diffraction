    ...
    : QDockWidget(tr("Tools"),parent)
{
    ...
    apertureRadius_ = addManipulator(layout, this, tr(u8"Rad&ius of aperture"), 0.1, 50, 1, 2, tr(" mm"));
    curvatureRadius_ = addManipulator(layout, this, tr(u8"Ra&dius of curvature of side"), 1, 50, 3, 2, tr(u8" Rₐₚₜ"));

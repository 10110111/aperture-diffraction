...
void main()
{
    ...
    vec2 pointInTargetPlane = (gl_FragCoord.st - round(imageSize/2) + sampleShift) / (imageSize.x/2) * targetWidth;
    ...
    XYZW += colorScale*radianceToLuminance*(XYZW_re*XYZW_re+XYZW_im*XYZW_im);
}
)"
